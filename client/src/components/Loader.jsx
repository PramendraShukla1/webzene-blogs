...
const Loader = () => {
  return (
    <div className='min-h-screen flex justify-center flex-col gap-10 w-full items-center lg:p-0 p-1'>
    <div class="flex flex-wrap items-center gap-8 animate-pulse">
    <div class="grid bg-gray-300 rounded-lg lg:h-36 h-20 lg:w-36 w-20 place-items-center">
