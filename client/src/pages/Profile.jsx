...
const Profile = () => {
  ...
  return (
    <>
        ...
        <div className="h-full w-full flex lg:flex-row flex-col bg-white rounded-2xl lg:max-w-screen-2xl items-center shadow-lg">
          ...
          <div className=" lg:w-1/2 w-full flex justify-center items-center h-fit relative">
            <img
              src={icon}
              alt=""
              className="w-auto h-auto lg:flex hidden z-10"
            />
          </div>
          ...
          <div className=" bg-white p-10 lg:w-1/2 w-full rounded-2xl">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-semibold">{username}'s Profile</h1>
            </div>
      ...
      <div className="bg-gray-200 p-20 pb-1 text-center lg:text-start flex justify-center">
        <h1 className="lg:text-6xl text-3xl font-semibold text-gray-800 mb-10 lg:mb-0">
          Your Posts
        </h1>
      </div>

      {Array.isArray(posts) && posts.length > 0 ? (
        posts.map((post) => <ProfilePosts post={post} key={post._id} />)
      ) : (
        <div className="lg:p-20 p-10 bg-gray-200 flex justify-center flex-col items-center">
