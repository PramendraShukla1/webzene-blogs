      ...
      <div className="h-full w-full flex lg:flex-row flex-col bg-white rounded-2xl lg:max-w-screen-lg items-center shadow-lg">
        ...
        <div className=" bg-white p-10 lg:w-1/2 w-full rounded-2xl">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-semibold">Webzene Blog Editor</h1>
          </div>
          <form action="" className="flex flex-col gap-5 ">
            <div className="flex flex-col gap-4 justify-center items-center mt-10">
              ...
              <div className="flex gap-5 w-full flex-col lg:flex-row">
                ...
                />
                <Button onClick={addCategory} variant="gradient" className="lg:w-1/5 w-full">
                  Add Tag
                </Button>
              </div>
              <div className="flex gap-5 w-full flex-wrap mt-3 mb-5 justify-around">
                {(
                    cats?.map((item, index)=>(
                        <p  key={index} className="p-3 border rounded-xl font-semibold text-gray-700 flex items-center gap-2">
                        {item}{" "}
                        <MdDelete onClick={()=>deleteCategory(index)} className="lg:text-2xl text-lg text-gray-600 hover:text-black cursor-pointer" />
                      </p>
                    )))
                }
              ...
              <div className="w-full">
                <textarea  value={desc}
                onChange={(e)=>setDesc(e.target.value)} name="" id="" cols="30" rows="5" className="border w-full p-5 text-lg font-medium outline-none rounded-xl" placeholder="Write your blog here"></textarea>
              </div>
              <input
                type="file"
                required
            ...
            <Button variant="gradient" onClick={handleEditPost}>Update</Button>
          </form>
        </div>
